...
func Init(gpu int) {
	...
	if err := program.BuildProgram([]*cl.Device{ClDevice}, "-cl-std=CL1.2 -cl-mad-enable -cl-fp32-correctly-rounded-divide-sqrt -cl-no-signed-zeros -cl-denorms-are-zero -cl-kernel-arg-info -cl-finite-math-only"); err != nil {
